...
var http = require('http'),
    ...
    swaggerUi = require('swagger-ui-express'), // line 7
    swaggerJSDoc = require('swagger-jsdoc'), // line 8
    transport = 'HTTP';
...
function start(callback) {
    ...
    var options = {
        ...
        swaggerDefinition: {
            info: {
                ...
                description: 'This documentation explains the POST and GET requests to the route /iot/d'
            }
        },
    ...
    // ...
    httpBindingServer.app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerSpec)); // line 45
     ...
     *      description: "This request add a new device to the datebase"
     ...
     *        404:
     *          description: "Not Found - The device has not been located"
     */
     ...
     *        c:
     *            type: integer
     *            description: Confirmation 1->true 0->false
     *   Devices:
     *      type: object
     *      properties:
     *        device_id:
